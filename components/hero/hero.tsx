...
const Hero = () => {
  return (
    <section className="max-w-7xl mx-auto mt-14 sm:mt-0 flex min-h-screen flex-col items-center justify-center gap-8 px-6 lg:flex-row lg:gap-16 lg:py-16">
      <div className="flex w-full max-w-2xl flex-col items-start gap-6 sm:gap-8 lg:gap-10">
        ...
        <h1 className="text-7xl font-extrabold sm:text-5xl md:text-6xl lg:text-7xl">
          {profile.name}
        </h1>
